...
export default class planetEarth extends Standard2DPGAPosedVertexColorObject {
    ...
    constructor(device, canvasFormat, pose) {
        ...
        while (i < 360) {
            ...
            vertices[idx * 18 + 2] = (39.0 / 255);
            vertices[idx * 18 + 3] = (86.0 / 255);
            vertices[idx * 18 + 4] = (217.0 / 255);
            vertices[idx * 18 + 5] = (1);
            ...
            vertices[idx * 18 + 8] = (168.0 / 255);
            vertices[idx * 18 + 9] = (132.0 / 255);
            vertices[idx * 18 + 10] = (2.0 / 255);
            vertices[idx * 18 + 11] = (1);

            //third point of the triangle
            vertices[idx * 18 + 12] = (centerx);
            vertices[idx * 18 + 13] = (centery);
            vertices[idx * 18 + 14] = (2.0 / 255);
            vertices[idx * 18 + 15] = (168.0 / 255);
            vertices[idx * 18 + 16] = (24.0 / 255);
        ...
        this._t = 0;
        this._step = 1.6;
        this._pose0 = [-2.1, 0, 0.5, 0.5, 0.5, 0.5];
        this._pose1 = [-2.1, 1, -0.5, 0.5, 0.5, 0.5];
