...
export default class planetUranus extends Standard2DPGAPosedVertexColorObject {
    ...
    constructor(device, canvasFormat, pose) {
        ...
        while (i < 360) {
            ...
            vertices[idx * 18 + 2] = (100.0 / 255);
            vertices[idx * 18 + 3] = (44.0 / 255);
            vertices[idx * 18 + 4] = (130.0 / 255);
            vertices[idx * 18 + 5] = (1);
            ...
            vertices[idx * 18 + 8] = (100.0 / 255);
            vertices[idx * 18 + 9] = (44.0 / 255);
            vertices[idx * 18 + 10] = (130.0 / 255);
            vertices[idx * 18 + 11] = (1);

            //third point of the triangle
            vertices[idx * 18 + 12] = (centerx);
            vertices[idx * 18 + 13] = (centery);
            vertices[idx * 18 + 14] = (100.0 / 255);
            vertices[idx * 18 + 15] = (44.0 / 255);
            vertices[idx * 18 + 16] = (130.0 / 255);
        ...
        this._t = 0;
        this._step = 0.7;
        this._pose0 = [-0.85, 0, 0.5, 0.5, 0.5, 0.5];
        this._pose1 = [-0.85, 0, 1, -0.5, 0.5, 0.5, 0.5];
