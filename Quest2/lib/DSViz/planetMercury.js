...
export default class planetMercury extends Standard2DPGAPosedVertexColorObject {
    ...
    constructor(device, canvasFormat, pose) {
        ...
        while (i < 360) {
            ...
            vertices[idx * 18 + 3] = (137.0 / 255);
            vertices[idx * 18 + 4] = (137.0 / 255);
            vertices[idx * 18 + 5] = (1);
            ...
            vertices[idx * 18 + 9] = (137.0 / 255);
            vertices[idx * 18 + 10] = (137.0 / 255);
            ...
            vertices[idx * 18 + 15] = (137.0 / 255);
            vertices[idx * 18 + 16] = (137.0 / 255);
        ...
        this._t = 0;
        this._step = 3;
        this._pose0 = [-4, 0, 0.5, 0.5, 0.5, 0.5];
        this._pose1 = [-4, 1, -0.5, 0.5, 0.5, 0.5];
