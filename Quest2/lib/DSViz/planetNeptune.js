...
export default class planetNeptune extends Standard2DPGAPosedVertexColorObject {
    ...
    constructor(device, canvasFormat, pose) {
        ...
        while (i < 360) {
            ...
            vertices[idx * 18 + 2] = (10.0 / 255);
            vertices[idx * 18 + 3] = (47.0 / 255);
            vertices[idx * 18 + 4] = (140.0 / 255);
            vertices[idx * 18 + 5] = (1);
            ...
            vertices[idx * 18 + 8] = (10.0 / 255);
            vertices[idx * 18 + 9] = (47.0 / 255);
            vertices[idx * 18 + 10] = (140.0 / 255);
            vertices[idx * 18 + 11] = (1);

            //third point of the triangle
            vertices[idx * 18 + 12] = (centerx);
            vertices[idx * 18 + 13] = (centery);
            vertices[idx * 18 + 14] = (12.0 / 255);
            vertices[idx * 18 + 15] = (177.0 / 255);
            vertices[idx * 18 + 16] = (207.0 / 255);
        ...
        this._pose1 = [-0.8, 0, 1, -0.5, 0.5, 0.5, 0.5];
